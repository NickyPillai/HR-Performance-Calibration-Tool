...
export function DistributionStats() {
  ...
  return (
    <div className={clsx(
      ...
      {hasFilters && (
        <p className={clsx('text-xs mb-2', isDark ? 'text-amber-400' : 'text-amber-600')}>
          Filtered: {employees.length} of {allEmployees.length} employees
        </p>
      )}
      ...
      {employees.length === 0 ? (
        ...
        <>
          ...
          <div className={clsx('mt-3 text-xs space-y-1', isDark ? 'text-slate-400' : 'text-gray-500')}>
